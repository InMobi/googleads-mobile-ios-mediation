//
//  GADMAdapterInMobiRTBUnifiedNativeAd.m
//  InMobiAdapter
//
...
#import "GADMAdapterInMobiRTBUnifiedNativeAd.h"
...
@interface GADMAdapterInMobiRTBUnifiedNativeAd () <IMNativeDelegate>
@end

@implementation GADMAdapterInMobiRTBUnifiedNativeAd {
...
- (void)loadNativeAdForAdConfiguration:(nonnull GADMediationNativeAdConfiguration *)adConfiguration completionHandler:(nonnull GADMediationNativeLoadCompletionHandler)completionHandler {
    ...
    GADMAdapterInMobiRTBUnifiedNativeAd *__weak weakSelf = self;
    ...
    [GADMAdapterInMobiInitializer.sharedInstance
     ...
     completionHandler:^(NSError *_Nullable error) {
        GADMAdapterInMobiRTBUnifiedNativeAd *strongSelf = weakSelf;
        if (!strongSelf) {
            return;
        }
...
- (void)requestNativeAdWithOptions:(nullable NSArray<GADAdLoaderOptions *> *)options {
  id<GADMediationNativeAdEventDelegate> strongDelegate = _nativeAdEventDelegate;
    
  id<GADMAdNetworkAdapter> strongAdapter = _adapter;
  if (!strongDelegate || !strongAdapter) {
    return;
  }
...
- (void)nativeDidFinishLoading:(nonnull IMNative *)native {
  ...
  __weak GADMAdapterInMobiRTBUnifiedNativeAd *weakSelf = self;
...
- (void)notifyCompletion {
 ...
 _nativeRenderCompletionHandler(self,nil);
