//
//  GADMAdapterInMobiRTBBannerAd.m
//  IMAdMobAdapter

#import "GADMAdapterInMobiRTBBannerAd.h"
...
@implementation GADMAdapterInMobiRTBBannerAd {
...
- (void)loadBannerForAdConfiguration:(nonnull GADMediationBannerAdConfiguration *)adConfiguration
    ...
    GADMAdapterInMobiRTBBannerAd *__weak weakSelf = self;
    ...
    [GADMAdapterInMobiInitializer.sharedInstance
     ...
     completionHandler:^(NSError *_Nullable error) {
        GADMAdapterInMobiRTBBannerAd *strongSelf = weakSelf;
        if (!strongSelf) {
            return;
        }
